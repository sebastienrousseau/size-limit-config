...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/size-limit-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fsize-limit-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/size-limit-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14519"><img src="https://img.shields.io/cii/level/14519?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Performance Bundle Budget Enforcement](#performance-bundle-budget-enforcement) — before and after rule comparison
...
Install `@sebastienrousseau/size-limit-config` as a development dependency:
...
Size Limit reads `.size-limit.json`, or a JS config that requires this package.
...
`@sebastienrousseau/size-limit-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/size-limit-config` solves this with three deliberate engineering choices:
...
When building backend server applications or CLI utilities where bundle transfer size is not an end-user metric.
