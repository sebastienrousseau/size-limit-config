...
This document describes how @sebastienrousseau/size-limit-config is run: who decides what, how
...
@sebastienrousseau/size-limit-config is **maintainer-led**. As of the current release line it has a single
